                    ...
                    ...categories.map((category) {
                      ...
                      final match = categoryIcons.entries.firstWhere(
                        ...
                        orElse:
                            () => MapEntry('', {
                              'icon':
                                  Icons.category, // Default icon if no match
                              'color': Colors.grey,
                            }),
                      );
            ...
            slivers: [
                      ...
                      PopupMenuButton<String>(
                        ...
                        itemBuilder:
                            (BuildContext context) => <PopupMenuEntry<String>>[
                              ...
                              //   child: Row(
                              //     children: [
                              //       Icon(Icons.location_on, color: AppColors.OliveGrove),
                        ...
                        child: Container(
                          ...
                          child: const Center(child: GlowingGPSIcon(size: 22)),
                        ), // Adjust shadow
                      ),
                    ],
                  ),
                      ...
                      children: [
                        ...
                        TextButton.icon(
                          onPressed: () {
                            ...
                            context.read<CampaignBloc>().add(
                              GetAllCampaignsEvent(),
                            ); // Clear filter and reload all campaigns
                          },
                          icon: const Icon(
                            Icons.close,
                            size: 18,
              ...
              BlocConsumer<CampaignBloc, CampaignState>(
                ...
                builder: (context, state) {
                    ...
                    return SliverList(
                      delegate: SliverChildBuilderDelegate((context, index) {
                        return Padding(
                          ...
                          child: CampaignCard(campaign: state.campaigns[index]),
                        );
                  ...
                  } else if (_cachedAllCampaigns != null &&
                      _cachedAllCampaigns!.isNotEmpty) {
                    return SliverList(
                      delegate: SliverChildBuilderDelegate((context, index) {
                        return Padding(
                          padding: const EdgeInsets.symmetric(
                          ...
                          child: CampaignCard(
                            campaign: _cachedAllCampaigns![index],
                          ),
                        );
                      }, childCount: _cachedAllCampaigns!.length),
                    );
                  } else if (state is CampaignErrorState) {
