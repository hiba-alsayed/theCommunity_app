               ...
               slivers:[
                 ...
                 BlocConsumer<ComplaintBloc, ComplaintState>(
                   ...
                   builder: (context, state) {
                       ...
                       return SliverList(
                         delegate: SliverChildBuilderDelegate((context, index) {
                           return Padding(
                             ...
                             child: ComplaintCard(complaint: state.complaints[index]),
                           );
                     ...
                     } else if (_cachedAllComplaints != null &&
                         _cachedAllComplaints!.isNotEmpty) {
                       return SliverList(
                         delegate: SliverChildBuilderDelegate((context, index) {
                           return Padding(
                             padding: const EdgeInsets.symmetric(
                             ...
                             child: ComplaintCard(
                               complaint: _cachedAllComplaints![index],
                             ),
                           );
                         }, childCount: _cachedAllComplaints!.length),
                       );
                     } else if (state is ComplaintErrorState) {
